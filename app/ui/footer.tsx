...
const Footer = () => {
  ...
  return (
    <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8 rounded-t-2xl">
      <div className="gap-6 justify-between md:flex">
        <div className="flex-1">
          <div className="max-w-xs">
            <Link
              href="/"
              className="xs:text-3xl md:text-4xl lg:text-6xl font-extrabold"
            >
              SpireHaus
            </Link>
